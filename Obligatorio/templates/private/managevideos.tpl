                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="manageVideosTable" class="table table-striped ">
                                <thead>
                                    <th>Title</th><th>Client</th><th>Views</th><th>Rating</th><th>Url</th><th>Featured</th><th>Active</th><th>Release Date</th><th>Description</th><th colspan="3">Actions</th>
                                </thead>
                                <tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table id="manageVideosTableDeleted" class="table table-striped">
                                <thead>
                                <th>Title</th><th>Client</th><th>Views</th><th>Rating</th><th>Url</th><th>Featured</th><th>Active</th><th width="110px">Release Date</th><th>Description</th><th colspan="2">Actions</th>
                                </thead>
                                <tbody>
                                    {foreach from=$videos item=video}
                                        {if $video['deleted'] == 1}
