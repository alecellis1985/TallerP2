            ...
            <div class="row bottom bottom-buffer">
                <div class="col-md-12 ">
					...
					<tr data-id="{$video['idVideo']}">
                                            <td><div>{$video['client']}</div></td>
						<td><div>{$video['views']}</div></td>
						<td><div>{$video['url']}</div></td>
                                                <td><div>{$video['destacado']}</div></td>
                                                <td><div>{$video['deleted']}</div></td>
                                                <td><div>{$video['releaseDate']}</div></td>
                                                <td><div>{$video['description']}</div></td>
						<td>
